---
slug: Titanic 생존률 분석 AI 바이브 코딩으로 하기 1
title: Titanic 생존률 분석 AI 바이브 코딩으로 하기 1
authors: [hjlim1]
date: 2026-01-10
tag: [llm]
image: /img/usecase/hjlim1/titanic_llm_1.jpg
description: 데이터 분석의 시작인 타이타닉 생존률 분석을 AI 코딩으로 배워 봅니다. 바이브코딩의 개념 및 툴 설명을 다루고 있습니다. 
---
