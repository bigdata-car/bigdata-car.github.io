---
sidebar_label: 가상서버 관리하기
---

# 가상서버 관리하기

<figure><img src="/img/manual/cloud/server2/server2_1.png" alt="" /><figcaption></figcaption></figure>
...
4. 추가 기능 \
   ![](</img/manual/cloud/server2/server2_2.png>)\
...
6. 서버 이벤트 : 사용자가 서버에 명령하는 시작, 중지 등의 액션에 대한 실행 이력을 표시합니다.\
   ![](</img/manual/cloud/server2/server2_3.png>)
7. 서버 부트 로그 : 서버가 시작될 때 기록되는 Booting Log를 표시합니다.\
   ![](</img/manual/cloud/server2/server2_4.png>)
8. 시스템 로그 : \
   ![](</img/manual/cloud/server2/server2_5.png>)
9. 가상머신 모니터링 : 가상서버 모니터링   정보를 상세히 조회 할 수 있습니다. \
   ![](</img/manual/cloud/server2/server2_6.png>)
10. 알람이벤트 \
    ![](</img/manual/cloud/server2/server2_7.png>)
