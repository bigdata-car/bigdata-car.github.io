...
<figure><img src="/img/manual/cloud/server_/server_1.png" alt="" /><figcaption></figcaption></figure>

1. 가상서버 생성할 프로젝트를 선택 합니다.&#x20;
2. 프로젝트 하위 기능 중에서 \[서버관리]를 선택 합니다.&#x20;
3. 서버 만들기를 선택 합니다.&#x20;

## 2. 생성할 가상 서버 설정 하기&#x20;

<figure><img src="/img/manual/cloud/server_/server_2.png" alt="" /><figcaption></figcaption></figure>
...
7. 서버생성 : 선택시 생성 절차가 시작 됩니다.                   \
   ![](</img/manual/cloud/server_/server_3.png>)
...
<figure><img src="/img/manual/cloud/server_/server_4.png" alt="" /><figcaption></figcaption></figure>

1. 이름 : 서버 관리 페이지로 이동 합니다.&#x20;
2. 접속정보 : 접속 IP, 계정, 인증키 정보를 알 수 있습니다. \
   ![](</img/manual/cloud/server_/server_5.png>)
3. 웹 터미널 : 기반 SSH 클라이언트에 접속 합니다. \
   (웹 기반 툴의 속성상 작업은 SSH 클라이언트 프로그램을 추천 합니다. )
4. 포트포워딩 : 외부 접속 설정을 위한 페이지로 이동 합니다. [\[상세\]](VM.md)
5. 가상머신의 자원 사용량을 표시 합니다. (로그인시 기능이 활성화 됩니다.)
6. 가상 서버 기능 메뉴가 표시 됩니다. \
   ![](</img/manual/cloud/server_/server_6.png>)\
   ...
   다운그레이드 합니다.  \
   . 백업 이미지 생성 : 정지 중인 가상 서버의 현 상태를 백업(스냅샷)으로 보관 합니다. [\[상세\]](VM-backup.md)\
   . 디스크 연결 : 기존에 생성된 저장공간을 연결 합니다. \
